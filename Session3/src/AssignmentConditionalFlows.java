import java.util.*;
public class AssignmentConditionalFlows {
...
Scanner scanner = new Scanner(System.in);
		...
		*/
		...
		if(amountToPay >= 399) {
			...
			// Ladder if/else
			if(promoCode==ICICTREATS || promoCode==KOTAK200) {
				
			
			
			if(promoCode==ICICTREATS && amountToPay<499) {
				
				System.out.print("You need to use correct promo code KOTAK200 ie 1");
				...
				System.out.println("Please Pay: \u20b9"+(amountToPay-discount));
			}else if(promoCode == KOTAK200 && amountToPay>=499) {
				// Nested if/else
				System.out.print("You are suggested to use ICICTREATS promo Code" );
				double discount = 0.20 * amountToPay;
